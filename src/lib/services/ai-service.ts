 ...
 */
const ENHANCEMENT_SYSTEM_PROMPT = `You are an expert prompt engineer. Transform raw notes into clear, structured AI agent prompts.
...
export class AIService {
     ...
     */
    async enhancePrompt(content: string, config: AIConfig): Promise<string> {
